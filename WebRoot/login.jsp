...
<body>
	<DIV class="top_div">
			<span class="logo_title">有伴后台管理平台</span>
	</DIV>
	<DIV
	...
	<form action="admin/admin_login" method="post">
		<P style="padding: 0px; position: relative;color: red;">
			<SPAN class="msg"><s:property value="#request.msg"></s:property></SPAN>

		</P>
		<P style="padding: 30px 0px 10px; position: relative;">
			<SPAN class="u_logo"></SPAN> <INPUT class="ipt" type="text"
				placeholder="请输入用户名" name="admin.adminName">

		</P>

		<P style="position: relative;">
			<SPAN class="p_logo"></SPAN> <INPUT class="ipt" id="password"
				type="password" placeholder="请输入密码" name="admin.password" >
		...
		<DIV
			...
			<button type="submit"
				style="float: right;background: rgb(0, 142, 173);margin: 10px 35px 20px 45px; padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255);">登录</button>
