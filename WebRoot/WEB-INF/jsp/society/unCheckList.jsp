...
<form id="pagerForm" method="post" action="admin/society_unCheckList">
...
<div class="pageContent" >
	<div class="panelBar">
		<ul class="toolBar">
			<li><a title="确实要审核通过这些社团吗?" target="selectedTodo" rel="ids"  href="admin/society_batchCheckPass?society.status=0&flag=1" class="edit"><span>批量审核通过</span></a></li>
		</ul>
	</div>
	<table class="list" width="100%" layoutH="53">
		...
		<tbody>
			<s:iterator value="pages.recordList" var="soc">
				...
				<td>${soc.introduce }</td>
				<td>
					<a title="通过" target="ajaxTodo" href="admin/society_checkPass?society.societyId=${soc.societyId }&society.status=0&flag=1" ><button style="background-color:#999999;">通过</button></a>
				</td>
			</tr>
			</s:iterator>
		</tbody>
